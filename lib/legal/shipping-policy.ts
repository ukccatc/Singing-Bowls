    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'If your country is not available at checkout, please contact us at info@himalayansound.com and we will arrange a custom quote.',
        ],
      },
      {
        id: 'ukraine',
      ...
      },
      {
        ...
        paragraphs: [
          'Occasional delays may occur due to customs clearance, weather, strikes, or force majeure. If your parcel is significantly delayed, contact info@himalayansound.com and we will open an investigation with the carrier.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Himalayan Sound — info@himalayansound.com — Kathmandu Valley, Nepal',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Якщо вашої країни немає у формі оформлення замовлення, напишіть на info@himalayansound.com — підготуємо індивідуальний розрахунок.',
        ],
      },
      {
        id: 'ukraine',
      ...
      },
      {
        ...
        paragraphs: [
          'Можливі затримки через митне оформлення, погоду, страйки або форс-мажор. Якщо посилка суттєво затримується, напишіть на info@himalayansound.com — ми відкриємо розслідування у перевізника.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Himalayan Sound — info@himalayansound.com — долина Катманду, Непал',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Если вашей страны нет в форме оформления, напишите на info@himalayansound.com — подготовим индивидуальный расчёт.',
        ],
      },
      {
        id: 'ukraine',
      ...
      },
      {
        ...
        paragraphs: [
          'Возможны задержки из-за таможенного оформления, погоды, забастовок или форс-мажора. Если посылка значительно задерживается, напишите на info@himalayansound.com — мы откроем расследование у перевозчика.',
