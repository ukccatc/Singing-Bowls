...
export default function OrderConfirmationContent({ params }: { params: Promise<{ locale: Locale }> }) {
          ...
          <div className="max-w-3xl mx-auto">
            <Card className="border-0 shadow-lg mb-8">
              <CardContent className="p-8 text-center">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-charcoal-900 mb-4">Order Confirmed!</h1>
            ...
            <Card className="border-0 shadow-lg mb-8">
              <CardContent className="p-8">
                <h2 className="text-2xl font-bold text-charcoal-900 mb-6">What happens next?</h2>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-charcoal-900 mb-2">1. Order Confirmation</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-charcoal-900 mb-2">2. Order Processing</h3>
                      <p className="text-charcoal-700">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-charcoal-900 mb-2">3. Shipping Notification</h3>
                      <p className="text-charcoal-700">
