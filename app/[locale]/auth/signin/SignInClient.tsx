...
export default function SignInClient({ locale }: { locale: Locale }) {
  return (
        ...
        <Card className="border-0 shadow-lg">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-charcoal-900 mb-2">Sign In</h1>
              <p className="text-charcoal-700">Welcome back to Himalayan Sound</p>
            </div>
