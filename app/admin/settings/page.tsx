    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-gray-700">
          ...
          <p>7. Set Gmail SMTP (<code className="rounded bg-gray-100 px-1">SMTP_USER</code>, <code className="rounded bg-gray-100 px-1">SMTP_PASS</code>) — see <code className="rounded bg-gray-100 px-1">docs/email-setup.md</code></p>
        </CardContent>
      </Card>
